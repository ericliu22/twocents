...
public struct GroupManager {
    ...
    public static let GROUP_URL: URL = API_URL.appending(path: "group")
    ...
    public static func fetchGroupMembers(groupId: UUID) async throws -> [User] {
    ...
    public static func fetchUserGroups() async throws -> [FriendGroup] {
        let request = Request<String> (
            method: .GET,
            contentType: .json,
